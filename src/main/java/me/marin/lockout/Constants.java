...
public class Constants {
    ...
    public static final Identifier UPDATE_PICKS_BANS_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "update_picks_bans");
    public static final Identifier BROADCAST_PICK_BAN_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "broadcast_pick_ban");
    public static final Identifier SYNC_PICK_BAN_LIMIT_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "sync_pick_ban_limit");
    public static final Identifier SET_BOARD_TYPE_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "set_board_type");
    public static final Identifier UPLOAD_BOARD_TYPE_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "upload_board_type");
    public static final Identifier ANNOUNCE_GOAL_FOCUS_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "announce_goal_focus");
    public static final Identifier REQUEST_GOAL_DETAILS_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "request_goal_details");
    public static final Identifier GOAL_DETAILS_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "goal_details");
    public static final Identifier DOWNLOAD_STATISTICS_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "download_statistics");
    
    public static final Identifier START_PICK_BAN_SESSION_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "start_pick_ban_session");
    public static final Identifier UPDATE_PICK_BAN_SESSION_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "update_pick_ban_session");
    public static final Identifier LOCK_PICK_BAN_SELECTIONS_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "lock_pick_ban_selections");
    public static final Identifier END_PICK_BAN_SESSION_PACKET = Identifier.fromNamespaceAndPath(NAMESPACE, "end_pick_ban_session");
