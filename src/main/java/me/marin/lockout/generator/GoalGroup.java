...
public class GoalGroup {
    ...
    public static final GoalGroup DAMAGE = new GoalGroup(List.of(
            DEAL_400_DAMAGE, OPPONENT_TAKES_100_DAMAGE, TAKE_200_DAMAGE, DAMAGED_BY_7_UNIQUE_SOURCES
    ), 1);
    ...
    public static final GoalGroup OBTAIN_ALL = new GoalGroup(List.of(
           OBTAIN_ALL_HORSE_ARMOR, OBTAIN_ALL_MINECARTS, OBTAIN_ALL_PUMPKINS, OBTAIN_ALL_MUSHROOMS, OBTAIN_ALL_RAW_ORE_BLOCKS, OBTAIN_4_UNIQUE_SEEDS, OBTAIN_ALL_TORCHES, OBTAIN_3_UNIQUE_BANNER_PATTERNS
    ), 2);
