...
public class GoalGroup {
    ...
    public static final GoalGroup KILL_MOB = new GoalGroup(List.of(
            ...
            KILL_BREEZE_USING_WIND_CHARGE, KILL_SLIME, KILL_BOGGED
    ), 2);
    ...
    public static final GoalGroup HORSE = new GoalGroup(List.of(
            TAME_HORSE, RIDE_HORSE, OBTAIN_ALL_HORSE_ARMOR, EQUIP_HORSE_WITH_COLORED_LEATHER_ARMOR
    ), 1);
    public static final GoalGroup BREED = new GoalGroup(List.of(
            BREED_CHICKEN, BREED_COW, BREED_FOX, BREED_GOAT, BREED_HOGLIN, BREED_PIG, BREED_RABBIT, BREED_SHEEP, BREED_STRIDER, BREED_FROGS, BREED_ARMADILLO
    ), 2);
    ...
    public static final GoalGroup EAT_FOOD = new GoalGroup(List.of(
            EAT_CAKE, EAT_CHORUS_FRUIT, EAT_COOKIE, EAT_GLOW_BERRY, EAT_POISONOUS_POTATO, EAT_PUMPKIN_PIE, EAT_RABBIT_STEW, EAT_SUSPICIOUS_STEW, EAT_BEETROOT_SOUP
    ), 3);
    ...
    public static final GoalGroup OPPONENT_TAKES_DAMAGE = new GoalGroup(List.of(
            OPPONENT_TAKES_100_DAMAGE, OPPONENT_TAKES_FALL_DAMAGE, OPPONENT_CATCHES_ON_FIRE, OPPONENT_HIT_BY_ARROW
    ), 1);
    public static final GoalGroup OPPONENT_GOALS = new GoalGroup(List.of(
            ...
            OPPONENT_OBTAINS_CRAFTING_TABLE, OPPONENT_JUMPS, OPPONENT_TOUCHES_WATER,
            OPPONENT_HIT_BY_EGG, OPPONENT_HIT_BY_SNOWBALL, OPPONENT_DIES, OPPONENT_DIES_3_TIMES, OPPONENT_HIT_BY_ARROW
    ), 3);
    ...
    public static final GoalGroup DAMAGE = new GoalGroup(List.of(
            DEAL_400_DAMAGE, OPPONENT_TAKES_100_DAMAGE, TAKE_200_DAMAGE, DAMAGED_BY_8_UNIQUE_SOURCES
    ), 1);
    public static final GoalGroup ADVANCEMENT = new GoalGroup(List.of(
            ...
            GET_STAY_HYDRATED_ADVANCEMENT, GET_UNDER_LOCK_AND_KEY_ADVANCEMENT
    ), 4);
    ...
    public static final GoalGroup VILLAGE = new GoalGroup(List.of(
            ...
            WEAR_CHAIN_ARMOR_PIECE, EAT_BEETROOT_SOUP
    ), 3);
    ...
    public static final GoalGroup OBTAIN_ALL = new GoalGroup(List.of(
           OBTAIN_ALL_HORSE_ARMOR, OBTAIN_ALL_MINECARTS, OBTAIN_ALL_PUMPKINS, OBTAIN_ALL_MUSHROOMS, OBTAIN_ALL_RAW_ORE_BLOCKS, 
    ...
    public static final GoalGroup TRIAL_CHAMBERS = new GoalGroup(List.of(
            KILL_BREEZE_USING_WIND_CHARGE, KILL_SILVERFISH, GET_MINECRAFT_TRIALS_EDITION_ADVANCEMENT, GET_UNDER_LOCK_AND_KEY_ADVANCEMENT
    ), 1);
    ...
    public static final GoalGroup TOOLS_CATEGORY = new GoalGroup(List.of(
            OBTAIN_WOODEN_TOOLS, OBTAIN_STONE_TOOLS, OBTAIN_IRON_TOOLS, OBTAIN_GOLDEN_TOOLS, OBTAIN_DIAMOND_TOOLS, USE_BRUSH_ON_SUSPICIOUS_BLOCK, SHOOT_FIREWORK_FROM_CROSSBOW, HAVE_YOUR_SHIELD_DISABLED, BREAK_ANY_TOOL
    ), Integer.MAX_VALUE);
    public static final GoalGroup ARMOR_CATEGORY = new GoalGroup(List.of(
            WEAR_LEATHER_ARMOR, WEAR_IRON_ARMOR, WEAR_GOLDEN_ARMOR, WEAR_DIAMOND_ARMOR, WEAR_FULL_ENCHANTED_ARMOR, WEAR_4_UNIQUE_ARMOR_PIECES, 
    ...
    public static final GoalGroup BIOMES_CATEGORY = new GoalGroup(List.of(
            ...
            VISIT_MUSHROOM_BIOME, GET_HOT_TOURIST_DESTINATIONS_ADVANCEMENT
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup CONSUME_CATEGORY = new GoalGroup(List.of(
            EAT_5_UNIQUE_FOOD, EAT_10_UNIQUE_FOOD, EAT_15_UNIQUE_FOOD, EAT_20_UNIQUE_FOOD, EAT_25_UNIQUE_FOOD, EAT_BEETROOT_SOUP, EAT_CAKE, EAT_CHORUS_FRUIT, EAT_COOKIE, 
    ...
    public static final GoalGroup DEATH_CATEGORY = new GoalGroup(List.of(
            ...
            DIE_BY_IRON_GOLEM, DIE_BY_MAGIC, DIE_BY_TNT_MINECART, DIE_TO_POLAR_BEAR, DIE_TO_PUFFERFISH, DIE_TO_WARDEN
    ), Integer.MAX_VALUE);
    public static final GoalGroup KILL_CATEGORY = new GoalGroup(List.of(
            ...
            KILL_BLAZE_WITH_SNOWBALL, KILL_BOGGED, KILL_BREEZE_USING_WIND_CHARGE, KILL_COLORED_SHEEP, KILL_ELDER_GUARDIAN, KILL_GHAST, KILL_GUARDIAN, KILL_SILVERFISH, KILL_SNOW_GOLEM, KILL_SNOW_GOLEM_IN_NETHER, 
            KILL_SLIME, KILL_STRAY, KILL_WITCH, KILL_ZOGLIN, KILL_ZOMBIE_VILLAGER, ENRAGE_ZOMBIFIED_PIGLIN, KILL_OTHER_PLAYER
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup ENTER_STRUCTURE_DIMENSION_CATEGORY = new GoalGroup(List.of(
            GET_MINECRAFT_TRIALS_EDITION_ADVANCEMENT, ENTER_NETHER, GET_THOSE_WERE_THE_DAYS_ADVANCEMENT, GET_A_TERRIBLE_FORTRESS_ADVANCEMENT, GET_EYE_SPY_ADVANCEMENT, ENTER_END, GET_THE_CITY_AT_THE_END_OF_THE_GAME_ADVANCEMENT
    ), Integer.MAX_VALUE);
    public static final GoalGroup OPPONENT_DOES_X_CATEGORY = new GoalGroup(List.of(
            ...
            OPPONENT_HIT_BY_ARROW, OPPONENT_HIT_BY_EGG, OPPONENT_HIT_BY_SNOWBALL, OPPONENT_TAKES_100_DAMAGE, OPPONENT_TAKES_FALL_DAMAGE, OPPONENT_CATCHES_ON_FIRE, OPPONENT_TOUCHES_WATER
    ), Integer.MAX_VALUE);
    public static final GoalGroup WORKSTATION_CATEGORY = new GoalGroup(List.of(
            OBTAIN_7_UNIQUE_WORKSTATIONS, USE_ANVIL, USE_CAULDRON, USE_COMPOSTER, USE_ENCHANTING_TABLE, USE_GRINDSTONE, USE_JUKEBOX, USE_LOOM, TUNE_NOTE_BLOCK, USE_SMITHING_TABLE, USE_STONECUTTER
    ), Integer.MAX_VALUE);
    public static final GoalGroup FILL_INTERFACE_CATEGORY = new GoalGroup(List.of(
            FILL_ARMOR_STAND, FILL_BUNDLE_WITH_BUNDLES, FILL_CAMPFIRE, FILL_CHISELED_BOOKSHELF, FILL_INVENTORY_UNIQUE_ITEMS
    ), Integer.MAX_VALUE);
    public static final GoalGroup OBTAIN_CATEGORY = new GoalGroup(List.of(
            OBTAIN_3_UNIQUE_BANNER_PATTERNS, OBTAIN_4_UNIQUE_SAPLINGS, OBTAIN_4_UNIQUE_SEEDS, OBTAIN_5_UNIQUE_PRESSURE_PLATES, OBTAIN_5_UNIQUE_STONE_TYPES, OBTAIN_64_ARROWS, OBTAIN_64_COARSE_DIRT, OBTAIN_64_COLORED_CONCRETE, 
            OBTAIN_64_COLORED_GLASS, OBTAIN_64_COLORED_TERRACOTTA, OBTAIN_64_COLORED_WOOL, OBTAIN_6_UNIQUE_BUCKETS, OBTAIN_6_UNIQUE_FLOWERS,OBTAIN_64_FIREFLY_BUSHES, OBTAIN_64_GLOW_LICHEN, OBTAIN_ALL_FURNACE_TYPES, OBTAIN_ALL_HORSE_ARMOR, OBTAIN_ALL_MINECARTS, 
            OBTAIN_ALL_MUSHROOMS, OBTAIN_ALL_PUMPKINS, OBTAIN_ALL_RAW_ORE_BLOCKS, OBTAIN_ALL_TORCHES, OBTAIN_ACTIVATOR_RAIL, OBTAIN_AMETHYST_BLOCK, OBTAIN_ANCIENT_DEBRIS, OBTAIN_BELL, OBTAIN_BLOCK_OF_RESIN, OBTAIN_BOOKSHELF, OBTAIN_BRICK_WALL, 
            OBTAIN_CALIBRATED_SCULK_SENSOR, OBTAIN_CLOCK, OBTAIN_COBWEB, OBTAIN_COLORED_GLAZED_TERRACOTTA, OBTAIN_COLORED_HARNESS, OBTAIN_DAYLIGHT_DETECTOR, OBTAIN_DEAD_BUSH, OBTAIN_DETECTOR_RAIL, OBTAIN_DIAMOND_BLOCK, OBTAIN_DISPENSER, OBTAIN_DRAGON_EGG, OBTAIN_EMERALD_BLOCK, 
            OBTAIN_ENCHANT_BOTTLE, OBTAIN_ENDER_CHEST, OBTAIN_END_ROD, OBTAIN_FLOWERING_AZALEA, OBTAIN_HEART_OF_THE_SEA, OBTAIN_LODESTONE, OBTAIN_MOSSY_STONE_BRICK_WALL, OBTAIN_MUD_BRICK_WALL, OBTAIN_OBSERVER, OBTAIN_PISTON, OBTAIN_POTTERY_SHERD, 
            OBTAIN_POWDER_SNOW_BUCKET, OBTAIN_POWERED_RAIL, OBTAIN_REDSTONE_COMPARATOR, OBTAIN_REDSTONE_LAMP, OBTAIN_REDSTONE_REPEATER, OBTAIN_RED_NETHER_BRICK_STAIRS, OBTAIN_SCAFFOLDING, OBTAIN_SEA_LANTERN, OBTAIN_SMOOTH_QUARTZ_STAIRS, 
            OBTAIN_SOUL_CAMPFIRE, OBTAIN_SOUL_LANTERN, OBTAIN_SPONGE, OBTAIN_TINTED_GLASS, OBTAIN_TNT, OBTAIN_TROPICAL_FISH_BUCKET, OBTAIN_WITHER_SKELETON_SKULL
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup HAVE_MORE_CATEGORY = new GoalGroup(List.of(
            HAVE_MORE_XP_LEVELS, HAVE_MORE_UNIQUE_CRAFTS, HAVE_MOST_ADVANCEMENTS
    ), Integer.MAX_VALUE);
    public static final GoalGroup ADVANCEMENTS_CATEGORY = new GoalGroup(List.of(
            GET_10_ADVANCEMENTS, GET_20_ADVANCEMENTS, GET_30_ADVANCEMENTS, GET_ANY_SPYGLASS_ADVANCEMENT, GET_BULLSEYE_ADVANCEMENT, GET_HIRED_HELP_ADVANCEMENT, GET_NOT_QUITE_NINE_LIVES_ADVANCEMENT, GET_OH_SHINY_ADVANCEMENT, GET_SNIPER_DUEL_ADVANCEMENT, 
            GET_STAY_HYDRATED_ADVANCEMENT, GET_UNDER_LOCK_AND_KEY_ADVANCEMENT, GET_WAX_ON_ADVANCEMENT, GET_WAX_OFF_ADVANCEMENT, GET_WHAT_A_DEAL_ADVANCEMENT
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup MISCELLANEOUS_CATEGORY = new GoalGroup(List.of(
            DAMAGED_BY_8_UNIQUE_SOURCES, EMPTY_HUNGER_BAR, ITEM_FRAME_IN_ITEM_FRAME, LIGHT_CANDLE, PLACE_END_CRYSTAL, PLACE_PAINTING, 
