...
public class GoalGroup {
    ...
    public static final GoalGroup DAMAGE = new GoalGroup(List.of(
            DEAL_400_DAMAGE, OPPONENT_TAKES_100_DAMAGE, TAKE_200_DAMAGE, DAMAGED_BY_8_UNIQUE_SOURCES, DAMAGED_BY_12_UNIQUE_SOURCES
    ), 1);
    ...
    public static final GoalGroup OBTAIN_CATEGORY = new GoalGroup(List.of(
            OBTAIN_3_UNIQUE_BANNER_PATTERNS, OBTAIN_3_UNIQUE_MUSIC_DISCS, OBTAIN_4_UNIQUE_SAPLINGS, OBTAIN_4_UNIQUE_SEEDS, OBTAIN_5_UNIQUE_PRESSURE_PLATES, OBTAIN_5_UNIQUE_STONE_TYPES, OBTAIN_64_ARROWS, OBTAIN_64_COARSE_DIRT, OBTAIN_64_COLORED_CONCRETE, 
            ...
            OBTAIN_DRIED_KELP_BLOCK, OBTAIN_EMERALD_BLOCK, OBTAIN_ENCHANT_BOTTLE, OBTAIN_ENDER_CHEST, OBTAIN_END_ROD, OBTAIN_FLOWERING_AZALEA, OBTAIN_HEART_OF_THE_SEA, OBTAIN_LODESTONE, OBTAIN_MOSSY_STONE_BRICK_WALL, OBTAIN_MUD_BRICK_WALL, OBTAIN_OBSERVER, 
            OBTAIN_PISTON, OBTAIN_POTTERY_SHERD, OBTAIN_POWDER_SNOW_BUCKET, OBTAIN_POWERED_RAIL, OBTAIN_REDSTONE_COMPARATOR, OBTAIN_REDSTONE_LAMP, OBTAIN_REDSTONE_REPEATER, OBTAIN_RED_NETHER_BRICK_STAIRS, OBTAIN_SCAFFOLDING, OBTAIN_SEA_LANTERN, 
    ...
    public static final GoalGroup HAVE_MORE_CATEGORY = new GoalGroup(List.of(
            HAVE_MORE_XP_LEVELS, HAVE_MORE_CREEPER_KILLS, HAVE_MORE_UNIQUE_CRAFTS, HAVE_MOST_ADVANCEMENTS
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup MISCELLANEOUS_CATEGORY = new GoalGroup(List.of(
            DAMAGED_BY_8_UNIQUE_SOURCES, DAMAGED_BY_12_UNIQUE_SOURCES, EMPTY_HUNGER_BAR, ITEM_FRAME_IN_ITEM_FRAME, LIGHT_CANDLE, PLACE_END_CRYSTAL, PLACE_PAINTING, 
