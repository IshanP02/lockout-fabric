...
public class GoalGroup {
    ...
    public static final GoalGroup HORSE = new GoalGroup(List.of(
            TAME_HORSE, RIDE_HORSE, OBTAIN_3_UNIQUE_HORSE_ARMOR, EQUIP_HORSE_WITH_COLORED_LEATHER_HORSE_ARMOR
    ), 1);
    ...
    public static final GoalGroup LEATHER_HEAVY = new GoalGroup(List.of(
            WEAR_LEATHER_ARMOR, WEAR_UNIQUE_COLORED_LEATHER_ARMOR, FILL_BUNDLE_WITH_BUNDLES, EQUIP_HORSE_WITH_COLORED_LEATHER_HORSE_ARMOR
    ), 1);
    ...
    public static final GoalGroup SPYGLASS = new GoalGroup(List.of(
        LOOK_AT_HUSK, LOOK_AT_GUARDIAN, LOOK_AT_IRON_GOLEM, LOOK_AT_PIGLIN_BRUTE, LOOK_AT_HORSE, LOOK_AT_ENDERMAN, GET_ANY_SPYGLASS_ADVANCEMENT
    ), 1);
    ...
    public static final GoalGroup ARMOR_CATEGORY = new GoalGroup(List.of(
            ...
            EQUIP_HORSE_WITH_COLORED_LEATHER_HORSE_ARMOR, WEAR_CARVED_PUMPKIN_FOR_5_MINUTES
    ), Integer.MAX_VALUE);
    public static final GoalGroup TAME_CATEGORY = new GoalGroup(List.of(
            TAME_CAT, TAME_HORSE, TAME_NAUTILUS, TAME_PARROT, TAME_WOLF
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup SPYGLASS_CATEGORY = new GoalGroup(List.of(
            LOOK_AT_25_UNIQUE_MOBS, LOOK_AT_10_UNIQUE_MOBS, LOOK_AT_15_UNIQUE_MOBS, LOOK_AT_20_UNIQUE_MOBS, LOOK_AT_HUSK, LOOK_AT_GUARDIAN, LOOK_AT_IRON_GOLEM, LOOK_AT_PIGLIN_BRUTE, LOOK_AT_HORSE, LOOK_AT_ENDERMAN
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup KILL_CATEGORY = new GoalGroup(List.of(
            ...
            KILL_SLIME, KILL_STRAY, KILL_WITCH, KILL_ZOGLIN, KILL_ZOMBIE_VILLAGER, KILL_OTHER_PLAYER
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup WORKSTATION_CATEGORY = new GoalGroup(List.of(
            USE_ANVIL, USE_CAULDRON, USE_COMPOSTER, USE_ENCHANTING_TABLE, USE_GRINDSTONE, LOCK_MAP_USING_CARTOGRAPHY_TABLE, USE_JUKEBOX, USE_LOOM, TUNE_NOTE_BLOCK, USE_SMITHING_TABLE, USE_STONECUTTER
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup OBTAIN_CATEGORY = new GoalGroup(List.of(
            ...
            OBTAIN_64_COLORED_GLASS, OBTAIN_64_COLORED_TERRACOTTA, OBTAIN_64_COLORED_WOOL, OBTAIN_6_UNIQUE_BUCKETS, OBTAIN_6_UNIQUE_FLOWERS, OBTAIN_7_UNIQUE_WORKSTATIONS, OBTAIN_64_FIREFLY_BUSHES, OBTAIN_64_GLOW_LICHEN, OBTAIN_64_NAME_TAG, OBTAIN_ALL_FURNACE_TYPES, OBTAIN_3_UNIQUE_HORSE_ARMOR, OBTAIN_ALL_MINECARTS, 
    ...
    public static final GoalGroup MISCELLANEOUS_CATEGORY = new GoalGroup(List.of(
            DAMAGED_BY_8_UNIQUE_SOURCES, DAMAGED_BY_12_UNIQUE_SOURCES, DAMAGED_BY_15_UNIQUE_SOURCES, CONSTRUCT_COPPER_GOLEM, EMPTY_HUNGER_BAR, ENRAGE_ENDERMAN, ENRAGE_ZOMBIFIED_PIGLIN, ENRAGE_WOLF, EXTINGUISH_CAMPFIRE_WITH_SHOVEL, ITEM_FRAME_IN_ITEM_FRAME, LIGHT_CANDLE, PLACE_END_CRYSTAL, PLACE_PAINTING, 
            ...
            USE_GLOW_INK, OBTAIN_WRITTEN_BOOK, USE_GOLDEN_DANDELION_ON_BABY_MOB
    ), Integer.MAX_VALUE);
    public static final GoalGroup NAME_CATEGORY = new GoalGroup(List.of(
            NAME_SHEEP_JEB, NAME_RABBIT, NAME_IRON_GOLEM, NAME_VINDICATOR
    ), Integer.MAX_VALUE);
    ...
    static {
        ...
        GOAL_GROUPS.add(SPYGLASS_UNIQUE);
