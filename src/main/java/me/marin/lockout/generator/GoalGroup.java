...
public class GoalGroup {
    ...
    public static final GoalGroup BANNEDGOALS = new GoalGroup(List.of(
            ENTER_END, BREED_FROGS, KILL_ZOGLIN, KILL_SILVERFISH, KILL_15_UNIQUE_HOSTILE_MOBS, OBTAIN_ENCHANT_BOTTLE, 
            OBTAIN_WITHER_SKELETON_SKULL, OBTAIN_END_ROD, OBTAIN_DRAGON_EGG, OBTAIN_ALL_HORSE_ARMOR, PLACE_END_CRYSTAL, 
            BREW_INVISIBILITY_POTION, BREW_LINGERING_POTION, EAT_25_UNIQUE_FOOD, EAT_CHORUS_FRUIT, TOOT_GOAT_HORN, 
            GET_LEVITATION_STATUS_EFFECT, GET_THE_CITY_AT_THE_END_OF_THE_GAME_ADVANCEMENT, GET_EYE_SPY_ADVANCEMENT, 
            GET_6_STATUS_EFFECTS_AT_ONCE, GET_30_ADVANCEMENTS, KILL_OTHER_PLAYER, OPPONENT_OBTAINS_CRAFTING_TABLE, 
