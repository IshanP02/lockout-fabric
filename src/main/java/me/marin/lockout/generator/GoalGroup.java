...
public class GoalGroup {
    ...
    public static final GoalGroup TOOLS_CATEGORY = new GoalGroup(List.of(
            OBTAIN_WOODEN_TOOLS, OBTAIN_STONE_TOOLS, OBTAIN_COPPER_TOOLS, OBTAIN_IRON_TOOLS, OBTAIN_GOLDEN_TOOLS, OBTAIN_DIAMOND_TOOLS, USE_BRUSH_ON_SUSPICIOUS_BLOCK, SHOOT_FIREWORK_FROM_CROSSBOW, HAVE_YOUR_SHIELD_DISABLED, BREAK_ANY_TOOL
    ), Integer.MAX_VALUE);
    ...
    public static final GoalGroup KILL_CATEGORY = new GoalGroup(List.of(
            ...
            KILL_BLAZE_WITH_SNOWBALL, KILL_BOGGED, KILL_BREEZE_USING_WIND_CHARGE, KILL_COLORED_SHEEP, KILL_ELDER_GUARDIAN, KILL_GHAST, KILL_GUARDIAN, KILL_PARCHED, KILL_SILVERFISH, KILL_SNOW_GOLEM, KILL_SNOW_GOLEM_IN_NETHER, 
    ...
    public static final GoalGroup FILL_INTERFACE_CATEGORY = new GoalGroup(List.of(
            FILL_ARMOR_STAND, FILL_BUNDLE_WITH_BUNDLES, FILL_CAMPFIRE, FILL_CHISELED_BOOKSHELF, FILL_INVENTORY_UNIQUE_ITEMS, FILL_SHELF_WITH_SHELVES
    ), Integer.MAX_VALUE);
    public static final GoalGroup OBTAIN_CATEGORY = new GoalGroup(List.of(
            OBTAIN_3_UNIQUE_BANNER_PATTERNS, OBTAIN_3_UNIQUE_MUSIC_DISCS, OBTAIN_4_UNIQUE_SAPLINGS, OBTAIN_4_UNIQUE_SEEDS, OBTAIN_5_UNIQUE_PRESSURE_PLATES, OBTAIN_6_UNIQUE_BRICK_TYPES, OBTAIN_64_ARROWS, OBTAIN_64_COARSE_DIRT, OBTAIN_64_COLORED_CONCRETE, 
            ...
            OBTAIN_DRIED_KELP_BLOCK, OBTAIN_EMERALD_BLOCK, OBTAIN_ENCHANT_BOTTLE, OBTAIN_ENDER_CHEST, OBTAIN_END_ROD, OBTAIN_FLOWERING_AZALEA, OBTAIN_GILDED_BLACKSTONE, OBTAIN_HEART_OF_THE_SEA, OBTAIN_LODESTONE, OBTAIN_MOSSY_STONE_BRICK_WALL, OBTAIN_MUD_BRICK_WALL, OBTAIN_OBSERVER, 
    ...
    public static final GoalGroup MISCELLANEOUS_CATEGORY = new GoalGroup(List.of(
            DAMAGED_BY_8_UNIQUE_SOURCES, DAMAGED_BY_12_UNIQUE_SOURCES, CONSTRUCT_COPPER_GOLEM, EMPTY_HUNGER_BAR, ITEM_FRAME_IN_ITEM_FRAME, LIGHT_CANDLE, PLACE_END_CRYSTAL, PLACE_PAINTING, 
