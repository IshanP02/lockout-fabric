...
public class GoalGroup {
    ...
    public static final GoalGroup MISCELLANEOUS_CATEGORY = new GoalGroup(List.of(
            DAMAGED_BY_8_UNIQUE_SOURCES, DAMAGED_BY_12_UNIQUE_SOURCES, DAMAGED_BY_15_UNIQUE_SOURCES, CONSTRUCT_COPPER_GOLEM, EMPTY_HUNGER_BAR, ITEM_FRAME_IN_ITEM_FRAME, LIGHT_CANDLE, PLACE_END_CRYSTAL, PLACE_PAINTING, 
