...
public class DefaultGoalRegister {
    ...
    public static void registerGoals() {
        ...
        INSTANCE.register(GoalType.WEAR_4_UNIQUE_ARMOR_PIECES, Wear4UniqueArmorPiecesGoal.class);
        ...
        INSTANCE.register(GoalType.EQUIP_HORSE_WITH_COLORED_LEATHER_HORSE_ARMOR, EquipHorseWithUniqueColoredLeatherArmorGoal.class, null,
        ...
        INSTANCE.register(GoalType.OBTAIN_GILDED_BLACKSTONE, ObtainGildedBlackstoneGoal.class);
