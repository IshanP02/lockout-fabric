...
public class LookAtPiglinBruteGoal extends LookAtMobGoal implements TextureProvider {
    ...
    public LookAtPiglinBruteGoal(String id, String data) {
        super(id, data, EntityTypes.PIGLIN_BRUTE);
    }
    ...
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Constants.NAMESPACE, "textures/custom/spyglass/spyglass_piglin_brute.png");
