...
public class GetLevitationStatusEffectGoal extends StatusEffectGoal implements TextureProvider {
    ...
    public MobEffect getStatusEffect() {
        return MobEffects.LEVITATION.value();
    }

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Constants.NAMESPACE, "textures/custom/status_effect/levitation.png");
    @Override
