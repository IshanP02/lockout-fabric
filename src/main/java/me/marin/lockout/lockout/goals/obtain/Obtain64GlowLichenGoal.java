...
public class Obtain64GlowLichenGoal extends ObtainAllItemsGoal implements RequiresAmount {

    private static final ItemStack ITEM_STACK = Items.GLOW_LICHEN.getDefaultInstance();
    static {
        ITEM_STACK.setCount(64);
    }
    private static final List<Item> ITEMS = List.of(ITEM_STACK.getItem());

    public Obtain64GlowLichenGoal(String id, String data) {
        super(id, data);
    }
