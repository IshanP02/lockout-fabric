...
public class BreedFrogsGoal extends BreedAnimalGoal implements TextureProvider {
    ...
    public EntityType<?> getAnimal() {
        return EntityTypes.FROG;
    }

    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Constants.NAMESPACE, "textures/custom/breed/breed_frogs.png");
    @Override
