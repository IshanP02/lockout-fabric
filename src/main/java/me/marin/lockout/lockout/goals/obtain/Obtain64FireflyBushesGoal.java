...
public class Obtain64FireflyBushesGoal extends ObtainAllItemsGoal implements RequiresAmount {

    private static final ItemStack ITEM_STACK = Items.FIREFLY_BUSH.getDefaultInstance();
    static {
        ITEM_STACK.setCount(64);
    }
    private static final List<Item> ITEMS = List.of(ITEM_STACK.getItem());

    public Obtain64FireflyBushesGoal(String id, String data) {
        super(id, data);
    }
    ...
    public String getGoalName() {
        return "Obtain 64 Firefly Bushes";
    }
