...
public class HaveEffectsAppliedFor8MinutesGoal extends HaveEffectsAppliedForXMinutesGoal implements RequiresAmount, TextureProvider, CustomTextureRenderer {

    private final static ItemStack DISPLAY_ITEM_STACK = Items.BROWN_DYE.getDefaultStack();
    static {
        DISPLAY_ITEM_STACK.setCount(8);
    }

    public HaveEffectsAppliedFor8MinutesGoal(String id, String data) {
        super(id, data);
    }

    @Override
    public String getGoalName() {
        return "Have Effects Applied for 8 Minutes";
    }
    ...
    public boolean renderTexture(DrawContext context, int x, int y, int tick) {
        ...
        context.drawStackOverlay(MinecraftClient.getInstance().textRenderer, DISPLAY_ITEM_STACK, x, y, "8");
        return true;
    }
