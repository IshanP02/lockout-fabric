...
public class DamagedBy8UniqueSourcesGoal extends DamagedByUniqueSourcesGoal {

    private static final ItemStack ITEM_STACK = Items.TERRACOTTA.getDefaultStack();

    public DamagedBy8UniqueSourcesGoal(String id, String data) {
        super(id, data);
    }

    @Override
    public String getGoalName() {
        return "Take Damage from 8 Unique Sources";
    }
    ...
    public boolean renderTexture(DrawContext context, int x, int y, int tick) {
        ...
        context.drawStackOverlay(MinecraftClient.getInstance().textRenderer, ITEM_STACK, x, y, "8");
        return true;
    }
