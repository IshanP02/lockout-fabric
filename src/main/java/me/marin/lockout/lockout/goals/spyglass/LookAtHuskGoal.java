...
public class LookAtHuskGoal extends LookAtMobGoal implements TextureProvider {
    ...
    public LookAtHuskGoal(String id, String data) {
        super(id, data, EntityTypes.HUSK);
    }
    ...
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Constants.NAMESPACE, "textures/custom/spyglass/spyglass_husk.png");
