...
public class LookAt10UniqueMobsGoal extends LookAtUniqueMobsGoal {

    private final ItemStack ITEM = Items.SPYGLASS.getDefaultStack();

    public LookAt10UniqueMobsGoal(String id, String data) {
        super(id, data);
    ...
    public String getGoalName() {
        return "Look at 10 Unique Mobs with Spyglass";
    }
